...
from Naive_Bayes.datasets import load_male_female
from Naive_Bayes.feature import ContinuousFeature
from Naive_Bayes.feature import DiscreteFeature
from Naive_Bayes.navie_bayes import NaiveBayes


def main():
    dataset = load_male_female()
    ...
    prediction = clf.predict_record([6, 130, 8])
    sexsual = " female " if prediction == 0.0 else "male"
    print("We predict this person is " + sexsual +".")
